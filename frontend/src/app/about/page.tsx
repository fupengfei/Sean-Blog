...
function JavaIcon() {
  return <FaMugSaucer className="w-7 h-7" color="#ED8B00" aria-label="Java" />;
}

function SpringBootIcon() {
  return <SiSpringboot className="w-7 h-7" color="#6DB33F" aria-label="Spring Boot" />;
}

function SpringCloudIcon() {
  return <SiSpring className="w-7 h-7" color="#6DB33F" aria-label="Spring Cloud" />;
}

function SpringAIIcon() {
  return <SiSpring className="w-7 h-7" color="#6DB33F" aria-label="Spring AI" />;
}

function KafkaIcon() {
  return <SiApachekafka className="w-7 h-7" color="#231F20" aria-label="Kafka" />;
}

function MySQLIcon() {
  return <SiMysql className="w-7 h-7" color="#4479A1" aria-label="MySQL" />;
}

function RedisIcon() {
  return <SiRedis className="w-7 h-7" color="#DC382D" aria-label="Redis" />;
}

function ClaudeCodeIcon() {
  return <SiClaudecode className="w-7 h-7" color="#D97757" aria-label="Claude Code" />;
}

function DockerIcon() {
  return <SiDocker className="w-7 h-7" color="#2496ED" aria-label="Docker" />;
}

function VSCodeIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7 text-[#007ACC]" role="img" aria-label="VS Code">
